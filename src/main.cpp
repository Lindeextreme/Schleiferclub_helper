/* Sources from: https://github.com/j-mcc1993/LSM9DS1/blob/master/LSM9DS1_BasicAHRS_Nano33.ino
 */
...
{  
  ...
  if (delt_t > 500) { // update LCD once per half-second independent of read rate
    /* @Chris uncomment for processing visualisation
    if(SerialDebug) {
    ...
    */
    ...
    /* @Chris added for processing visualisation
